...
- **Brazil:** interministerial design portaria (5 s minimum per bet; no autoplay, turbo or loss celebrations; no skill suggestions; 180-day recertification). Announced 5 Aug 2026, not published as of 15 Sep 2026.
- **UK:** does RTS 14G's 5 s minimum apply to crash games? Research reads it as applying (casino games excluding slots); the Commission hasn't said so explicitly. Also watch for any extension of stake limits beyond reel-based slots.
- **Denmark:** bill L 127 (per-game approval for game variants); whether crash games are a lawful type under § 18.
- **Curaçao:** when foreign supplier registration opens (expected around Oct 2026; deadline 24 Dec 2026).
- **Kenya:** GRA fees for software suppliers; follow-up rules on crash games (bet limits, forced breaks).
- **Gibraltar:** start date of the Gambling Act 2025 tiered B2B regime.
...
## Isle of Man / Gibraltar. verified 2026-09-15, M/L
...
## Germany (GGL). verified 2026-09-15, M
...
## Netherlands (KSA). verified 2026-09-15, M/H
...
## Denmark (Spillemyndigheden). verified 2026-09-15, M
...
## Brazil (SPA/MF). verified 2026-09-15, H/M
...
## Kenya (GRA, Gambling Control Act 2025). verified 2026-09-15, H/M
