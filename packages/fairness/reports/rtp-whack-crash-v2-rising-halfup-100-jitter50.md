...
|---|---|---|---|---|
| auto cash-out x1.5 | 64.480% | 96.894% (±0.036%) | 96.998% (±0.002%) | PASS |
...
| cash out at 2s | 63.772% | 96.894% (±0.037%) | 96.999% (±0.002%) | PASS |
| cash out at 5s | 20.245% | 96.772% (±0.096%) | 96.997% (±0.003%) | PASS |
...
| cash out right after first boost | 60.903% | 96.938% (±0.292%) | 97.000% (±0.002%) | PASS |
