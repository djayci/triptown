...
|---|---|---|---|---|
| auto cash-out x1.5 | 64.564% | 97.002% (±0.036%) | 96.983% (±0.002%) | PASS |
| auto cash-out x2 | 48.461% | 97.063% (±0.050%) | 97.000% (±0.003%) | PASS |
| auto cash-out x10 | 9.710% | 97.186% (±0.148%) | 97.003% (±0.004%) | PASS |
| auto cash-out x100 | 0.976% | 97.702% (±0.492%) | 97.007% (±0.005%) | PASS |
| cash out at 2s | 84.856% | 97.548% (±0.021%) | 97.510% (±0.002%) | PASS |
| cash out at 5s | 63.853% | 97.066% (±0.037%) | 97.047% (±0.002%) | PASS |
| cash out at 10s | 31.893% | 97.086% (±0.071%) | 96.989% (±0.003%) | PASS |
| cash out right after first setback | 0.010% | 100.750% (±5.018%) | 96.958% (±0.006%) | PASS |
| cash out right after first boost | 61.002% | 97.173% (±0.227%) | 96.969% (±0.002%) | PASS |
| never cash out (caps only) | 0.010% | 100.750% (±5.018%) | 96.958% (±0.006%) | PASS |
