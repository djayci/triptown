...
|---|---|---|---|---|
| auto cash-out x1.5 | 64.586% | 97.047% (±0.036%) | 96.995% (±0.012%) | PASS |
...
| cash out at 2s | 89.021% | 96.993% (±0.019%) | 96.963% (±0.008%) | PASS |
| cash out at 5s | 71.999% | 97.048% (±0.034%) | 97.008% (±0.012%) | PASS |
| cash out at 10s | 40.525% | 97.035% (±0.065%) | 96.981% (±0.018%) | PASS |
| cash out right after first setback | 33.150% | 99.879% (±3.365%) | 96.927% (±0.033%) | PASS |
| cash out right after first boost | 66.495% | 96.782% (±0.153%) | 96.999% (±0.013%) | PASS |
