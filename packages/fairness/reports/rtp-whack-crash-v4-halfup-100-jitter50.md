...
|---|---|---|---|---|
| auto cash-out x1.5 | 64.530% | 96.963% (±0.036%) | 97.003% (±0.012%) | PASS |
...
| cash out at 2s | 86.482% | 96.965% (±0.021%) | 96.976% (±0.009%) | PASS |
| cash out at 5s | 63.931% | 96.941% (±0.040%) | 97.012% (±0.014%) | PASS |
| cash out at 10s | 27.336% | 96.819% (±0.088%) | 96.992% (±0.020%) | PASS |
| cash out right after first setback | 33.082% | 100.918% (±3.368%) | 96.967% (±0.033%) | PASS |
| cash out right after first boost | 66.443% | 97.016% (±0.284%) | 97.013% (±0.013%) | PASS |
