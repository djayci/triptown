...
|---|---|---|---|---|
| auto cash-out x1.5 | 64.530% | 96.945% (±0.036%) | 96.985% (±0.012%) | PASS |
| auto cash-out x2 | 48.385% | 96.904% (±0.050%) | 97.005% (±0.015%) | PASS |
| auto cash-out x10 | 9.670% | 96.782% (±0.148%) | 97.010% (±0.023%) | PASS |
| auto cash-out x100 | 0.971% | 97.152% (±0.491%) | 97.019% (±0.029%) | PASS |
| cash out at 2s | 86.482% | 96.272% (±0.021%) | 96.283% (±0.008%) | PASS |
| cash out at 5s | 63.931% | 96.939% (±0.040%) | 97.010% (±0.014%) | PASS |
| cash out at 10s | 27.336% | 96.823% (±0.088%) | 96.996% (±0.020%) | PASS |
| cash out right after first setback | 33.082% | 100.901% (±3.368%) | 96.949% (±0.033%) | PASS |
| cash out right after first boost | 66.443% | 96.986% (±0.284%) | 96.983% (±0.013%) | PASS |
