# RTP simulation: whack-crash/v1-rising+cap100

- Rounds: 10,000,000 (seed 1), 19.4s
- Config: `{"id":"whack-crash/v1-rising+cap100","rtp":0.97,"r0":0.12,"rmax":0.95,"tRamp":12,"lambda":0,"setbackFactor":0.5,"maxWinMultiplier":100,"tMax":60,"papers":1}`
...
| cash out at 10s | 0.973% | 97.327% (±0.310%) | 97.000% (±0.000%) | PASS |
