...
|---|---|---|---|---|
| auto cash-out x1.5 | 64.564% | 97.021% (±0.036%) | 97.002% (±0.002%) | PASS |
...
| cash out at 2s | 84.856% | 97.028% (±0.021%) | 96.991% (±0.001%) | PASS |
| cash out at 5s | 63.853% | 97.036% (±0.037%) | 97.018% (±0.002%) | PASS |
| cash out at 10s | 31.893% | 97.097% (±0.071%) | 96.999% (±0.003%) | PASS |
| cash out right after first setback | 0.010% | 100.750% (±5.018%) | 96.958% (±0.006%) | PASS |
| cash out right after first boost | 61.002% | 97.203% (±0.227%) | 96.999% (±0.002%) | PASS |
