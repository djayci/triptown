...
|---|---|---|---|---|
| auto cash-out x1.5 | 64.561% | 97.017% (±0.036%) | 97.002% (±0.002%) | PASS |
...
| cash out at 2s | 81.465% | 96.989% (±0.023%) | 96.985% (±0.002%) | PASS |
| cash out at 5s | 55.057% | 96.994% (±0.044%) | 97.012% (±0.002%) | PASS |
| cash out at 10s | 20.270% | 96.908% (±0.096%) | 97.002% (±0.003%) | PASS |
| cash out right after first setback | 0.009% | 94.000% (±4.847%) | 96.956% (±0.006%) | PASS |
| cash out right after first boost | 60.946% | 97.083% (±0.193%) | 97.000% (±0.002%) | PASS |
