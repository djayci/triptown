...
| 1 per second | 83.108% | 97.056% (±0.043%) | 97.001% (±0.000%) | PASS |
| 1 per 0.7 s | 87.685% | 97.028% (±0.031%) | 96.999% (±0.000%) | PASS |
| all 5 at 1.3 s | 78.288% | 97.019% (±0.026%) | 97.004% (±0.000%) | PASS |
