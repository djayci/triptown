...
|---|---|---|---|---|
| auto cash-out x1.5 | 64.586% | 97.048% (±0.036%) | 96.996% (±0.012%) | PASS |
| auto cash-out x2 | 48.466% | 97.067% (±0.050%) | 96.980% (±0.015%) | PASS |
| auto cash-out x10 | 9.694% | 97.023% (±0.148%) | 96.978% (±0.023%) | PASS |
| auto cash-out x100 | 0.978% | 97.842% (±0.492%) | 96.963% (±0.029%) | PASS |
| cash out at 2s | 89.021% | 97.020% (±0.019%) | 96.990% (±0.008%) | PASS |
| cash out at 5s | 71.999% | 97.034% (±0.034%) | 96.995% (±0.012%) | PASS |
| cash out at 10s | 40.525% | 97.034% (±0.065%) | 96.980% (±0.018%) | PASS |
| cash out right after first setback | 33.150% | 99.880% (±3.365%) | 96.928% (±0.033%) | PASS |
| cash out right after first boost | 66.495% | 96.784% (±0.153%) | 97.001% (±0.013%) | PASS |
