...
- Rounding: halfup at 1000 minor units per paper
- Target RTP 97.000%; rounding band at 1000 minor units per cash-out: 96.952% .. 97.048%; jurisdiction minimum 85.000%
...
| 1 per second | 88.212% | 96.909% (±0.039%) | 96.988% (±0.013%) | PASS |
| 1 per 0.7 s | 91.417% | 96.950% (±0.028%) | 96.989% (±0.011%) | PASS |
| all 5 at 1.3 s | 84.601% | 96.958% (±0.023%) | 96.988% (±0.010%) | PASS |
| 1 right after each setback | 34.623% | 106.027% (±4.405%) | 96.988% (±0.035%) | PASS |
