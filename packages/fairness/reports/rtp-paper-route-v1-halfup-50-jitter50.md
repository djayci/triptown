...
| 1 per second | 88.212% | 96.908% (±0.039%) | 96.987% (±0.013%) | PASS |
| 1 per 0.7 s | 91.417% | 96.950% (±0.028%) | 96.989% (±0.011%) | PASS |
| all 5 at 1.3 s | 84.601% | 96.961% (±0.023%) | 96.991% (±0.010%) | PASS |
| 1 right after each setback | 34.623% | 106.026% (±4.405%) | 96.988% (±0.035%) | PASS |
