...
export const EN = {
  ...
  'stage.ready': 'READY?',
  'stage.readySub': 'Step out before the lift reaches its floor.',
  'button.bet': 'BET {amount}',
  'button.collect': 'STEP OUT!',
  ...
  'label.floor': 'Floor',
  'label.zone': 'Zone',
  // The parts of the building the ride passes through. Each is entered at a multiplier, so they are
  // decoration over the value and never a hint about where the lift will stop.
  'zone.lobby': 'LOBBY',
  'zone.offices': 'OFFICES',
  'zone.skyLobby': 'SKY LOBBY',
  'zone.terrace': 'THE TERRACE',
  'zone.penthouse': 'PENTHOUSE',
  'zone.roof': 'THE ROOF',
  ...
  'run.winNow': 'STEP OUT NOW {amount}',
  'result.cashedOut': 'STEPPED OUT',
  ...
  'result.crashed': 'THE DOORS OPENED',
  'result.crashedSub': 'Stake not returned \u00b7 {amount}',
  'result.instant': 'The doors opened at the lobby.',

  'rules.title': 'How this game works',
  'rules.growth': 'The multiplier speeds up over the first {tRamp} seconds, then keeps that speed.',
  'rules.setbacks': 'The lift drops back a level about every {every} seconds on average, halving the current value. There is no warning.',
  'rules.boosts': 'The lift takes an express jump about every {every} seconds on average, raising the value by {percent}%. There is no warning.',
  'rules.instantBust': 'About {percent}% of rounds end immediately at x1.00 \u2014 the doors open at the lobby.',
  ...
  'rules.minCashoutNone': 'You can step out at any value, including below x1.00 after a drop.',
  ...
  'rules.belowStakeReturns': 'Because a drop can halve the value, stepping out can return less than your stake.',
  ...
  'rules.decoration': 'The floor number and the part of the building you are in are decoration over the multiplier, which is the value. Where the lift stops is fixed when the round starts, cannot be predicted, and nothing you tap changes it.',
