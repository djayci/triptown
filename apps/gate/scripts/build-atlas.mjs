...
// Usage: node scripts/build-atlas.mjs   Output: public/assets/atlas.png + atlas.json (committed).
import { Resvg } from '@resvg/resvg-js';
import { MaxRectsPacker } from 'maxrects-packer';
import { PNG } from 'pngjs';
import { mkdirSync, writeFileSync } from 'node:fs';
import { buildSprites } from '../art/art.mjs';

const SCALE = 2;
const PADDING = 4;
const OUT = 'public/assets';

const images = Object.entries(buildSprites()).map(([name, svg]) => {
